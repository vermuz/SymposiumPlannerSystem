...
<head>
<!--
<base href="http://localhost:8080/ACE2ReactionRuleML/index.jsp">
-->
...
<form name="form1" method="post" action="rruleml.jsp">
	<table width="80%" border="0" align="center" cellspacing="0"
				...
				<tr>
				  <td height="70" > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      <div align="left"><span class="STYLE18">&nbsp;<a href="http://localhost:8080/ACE2ReactionRuleML" ><img src="ruleml2011.jpg" width="442" height="73" border="0"></a></span></div></td>
				...
				<tr>
					<td height="30" class="downline-gud1">
						...
						<select name="agent" class="input1"
							...
							%>
							<option selected>
								All Prova Organizitional Agents
							</option>
							<%
								}
				...
				<tr>
					...
					<td height="30" colspan="3" class="downline-gud1">
						&nbsp;&nbsp;
						<strong>Solution 2: Using Attempto Controlled English</strong>   &nbsp;&nbsp;&nbsp;&nbsp;<a href="http://attempto.ifi.uyh.ch/site">Attempto Project</a>					</td>
				</tr>
				<tr>
				...
				<tr>
					<td height="30" colspan="2" class="downline-gud1">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<p><font color="#FF0000"><b><a href="http://localhost:8080/ruleml2011.prog">&nbsp;&nbsp;&nbsp;Lexicon URL</a></b></font>:
						&nbsp;&nbsp;&nbsp;

						<input name="ulexfile" type="text" class="input1" size="60"
							value="http://localhost:8080/ruleml2011.prog"> (Note: this link needs to be accessd by the external APE engine.)
					  </p>
						<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;						</br>
...
<tr><td height="30" colspan="2"  valign="top" class="downline-gud1">
  ...
  <div style="height:25">&nbsp;&nbsp;1. SymposiumPlanner-2011 Organizational Agent: (1) Prova Knowledge Base [<a href="http://localhost:8080/SymposiumPlannerSystem/SymposiumPlannerSystem.prova">Prova</a>], (2)Role Assignment Matrix [<a href="http://localhost:8080/SymposiumPlannerSystem/SymposiumPlannerSystem.owl">OWL</a>]</div>
<div style="height:25">  &nbsp;&nbsp;2. RuleML-2011@IJCAI Organizational Agent: Prova Knowledge Base [<a href="http://localhost:8080/RuleML-2011-IJCAI/RuleML-2011-IJCAI-Responder.prova">Prova</a>], (2) Role Assignment Matrix [<a href="http://localhost:8080/RuleML-2011-IJCAI/RuleML-2011-IJCAI.owl">OWL</a>]</div>
<div style="height:25">  &nbsp; 3. RuleML-2011@IJCAI General Chair Agent: Rule Base [<a href="http://localhost:8080/RuleML-2011-IJCAI/generalChairIJCAI-2011.posl">POSL</a>]</div>

<div style="height:25">  &nbsp; 4. RuleML-2011@IJCAI Publicity Chair Agent: (1) Rule Base [<a href="http://localhost:8080/RuleML-2011-IJCAI/publicityChairIJCAI-2011.posl">POSL</a>], (2) Taxonomy [<a href="http://localhost:8080/RuleML-2011-IJCAI/publicityChairOntologyIJCAI-2011.rdf">RDF</a>]</div>
<div style="height:25">  &nbsp; 5. RuleML-2011@IJCAI Liaison Chair Agent: Rule Base [<a href="http://localhost:8080/RuleML-2011-IJCAI/liaisonChairIJCAI-2011.posl">POSL</a>]</div>
<div style="height:25">  &nbsp;&nbsp;6. RuleML-2011@IJCAI Program Chair Agent: Rule Base [<a href="http://localhost:8080/RuleML-2011-IJCAI/programChairIJCAI-2011.posl">POSL</a>]</div>
<div style="height:25">  &nbsp;&nbsp;7. RuleML-2011@IJCAI Web Chair Agent: Rule Base [<a href="http://localhost:8080/RuleML-2011-IJCAI/programChairIJCAI-2011.posl">POSL</a>]</div>
<div style="height:25">  &nbsp;&nbsp;8. RuleML-2011@BRF Organizational Agent: (1) Prova Knowledge Base [<a href="http://localhost:8080/RuleML-2011-BRF/RuleML-2011-BRF-Responder.prova">Prova</a>], (2) Role Assignment Matrix [<a href="http://localhost:8080/RuleML-2011-BRF/RuleML-2011-BRF.owl">OWL</a>]</div>
<div style="height:25">  &nbsp;&nbsp;9. RuleML-2011@BRF General Chair Agent: Rule Base [<a href="http://localhost:8080/RuleML-2011-BRF/generalChairBRF-2011.posl">POSL</a>]</div>

<div style="height:25">  &nbsp;&nbsp;10. RuleML-2011@BRF Publicity Chair Agent: (1) Rule Base [<a href="http://localhost:8080/RuleML-2011-BRF/publicityChairBRF-2011.posl">POSL</a>], (2) Taxonomy [<a href="http://localhost:8080/RuleML-2011-BRF/publicityChairOntologyBRF-2011.rdf">RDF</a>]</div>
<div style="height:25">  &nbsp;&nbsp;11. RuleML-2011@BRF Liaison Chair Agent: Rule Base [<a href="http://localhost:8080/RuleML-2011-BRF/liaisonChairBRF-2011.posl">POSL</a>]</div>
<div style="height:25">&nbsp;&nbsp;12. RuleML-2011@BRF Program Chair Agent: Rule Base [<a href="http://localhost:8080/RuleML-2011-BRF/programChairBRF-2011.posl">POSL</a>]&nbsp;&nbsp;RuleML-2011@BRF Web Chair Agent: Rule Base [<a href="http://localhost:8080/RuleML-2011-BRF/programChairBRF-2011.posl">POSL</a>]</div>
</td>
</tr>
	</table></form>
